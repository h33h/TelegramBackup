...
async def save_entities_to_csv(entities, phone_number):
    """Save discovered entities to CSV file.
...
def get_flat_entity_list(entities):
    """Flatten entities dictionary into a single list.
    ...
    """
    return [entity for category in entities.values() for entity in category]
